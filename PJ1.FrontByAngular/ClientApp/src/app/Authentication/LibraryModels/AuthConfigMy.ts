...
export declare class AuthConfigMy extends AuthConfig {
	/**
	...
	/**
	 * Определяет, использовать ли OpenID Connect во время
	 * неявного потока.
	 * 
	 * Установить на TRUE, чтобы получить также iD_Token через OpenID Connect (OIDC) в дополнение к
	 * OAuth2 на основе Access_token
	 */
	oidc?: boolean;
